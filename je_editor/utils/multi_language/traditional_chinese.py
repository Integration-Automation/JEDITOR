traditional_chinese_word_dict = {
    ...
    "shortcut_duplicate_line": "複製行或選取內容",
    "shortcut_toggle_comment": "切換註解",
    "shortcut_move_line_up": "將該行上移",
    "shortcut_move_line_down": "將該行下移",
    "shortcut_jump_to_definition": "跳到定義",
    "shortcut_jump_to_matching_bracket": "跳到對應的括號",
    "shortcut_zoom_in": "放大字型",
    "shortcut_zoom_in_alternate": "放大字型（第二組按鍵）",
    "shortcut_zoom_out": "縮小字型",
