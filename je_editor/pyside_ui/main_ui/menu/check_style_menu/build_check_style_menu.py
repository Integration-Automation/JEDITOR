...
def set_check_menu(ui_we_want_to_set: EditorMain) -> None:
    ...
    ui_we_want_to_set.check_menu.yapf_check_python_action.setShortcut(
        shortcut_for("yapf_reformat"))  # 設定快捷鍵 / Set shortcut
    ...
    ui_we_want_to_set.check_menu.reformat_json_action.setShortcut(shortcut_for("reformat_json"))
    ...
    ui_we_want_to_set.check_menu.check_python_format.setShortcut(shortcut_for("check_python_format"))
