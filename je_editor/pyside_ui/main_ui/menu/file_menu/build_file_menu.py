...
def set_file_menu(ui_we_want_to_set: EditorMain) -> None:
    ...
    bind(ui_we_want_to_set.file_menu.new_file_action, "new_file")
    ...
    bind(ui_we_want_to_set.file_menu.open_file_action, "open_file")
    ...
    bind(ui_we_want_to_set.file_menu.open_folder_action, "open_folder")
    ...
    bind(ui_we_want_to_set.file_menu.save_file_action, "save_file")
