...
from je_editor.tkinter_ui.editor_main_ui.content_init.content_init import content_init
from je_editor.tkinter_ui.editor_main_ui.menu.build_menu import build_menu
from je_editor.tkinter_ui.editor_main_ui.menu.file_menu.build_file_menu import build_file_menu
from je_editor.tkinter_ui.editor_main_ui.menu.popup_menu.build_popup_menu import build_popup_menu
from je_editor.tkinter_ui.editor_main_ui.menu.run_menu.build_run_menu import build_run_menu
from je_editor.tkinter_ui.editor_main_ui.protocal_setting.set_ui_protocol import tkinter_set_protocol
from je_editor.tkinter_ui.editor_main_ui.redirect_output.redirect_output_to_tkinter_ui import redirect_output
from je_editor.tkinter_ui.editor_main_ui.ui_event_bind.event_bind import tkinter_event_bind
from je_editor.tkinter_ui.editor_main_ui.ui_grid.build_ui_grid import build_grid
from je_editor.tkinter_ui.editor_main_ui.ui_setting.ui_setting import tkinter_ui_setting
from je_editor.tkinter_ui.ui_event.auto_save.start_auto_save.start_auto_save import start_auto_save
from je_editor.tkinter_ui.ui_event.close.close_event import close_event
from je_editor.tkinter_ui.ui_event.execute.execute_code.exec_code import execute_code
from je_editor.tkinter_ui.ui_event.open_file.open_file_to_read.open_file_to_read import open_file_to_read
from je_editor.tkinter_ui.ui_event.open_file.open_last_edit_file.open_last_edit_file import open_last_edit_file
from je_editor.tkinter_ui.ui_event.save_file.save_file_to_open.save_file_to_open import save_file_then_can_run
from je_editor.tkinter_ui.ui_event.save_file.save_file_to_open.save_file_to_open import save_file_to_open
from je_editor.tkinter_ui.ui_event.text_process.program_exec.code_exec_manager import ExecManager
from je_editor.tkinter_ui.ui_event.text_process.program_exec.process_error import process_error_text
from je_editor.tkinter_ui.ui_event.text_process.shell.shell_exec_manager import ShellManager
...
class EditorMain(object):
    ...
    def __init__(self, use_theme=None, debug=False, main_window=Tk()):
        ...
        # tkinter_ui init should before grid and menu init
        content_init(self)
        build_grid(self)
