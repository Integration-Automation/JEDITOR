...
print(os.getcwd() + "/circle_ci_test_stable/exec/code_exec_test/get_exec_test.py")
exec_result = exec_code(os.getcwd() + "circle_ci_test_stable/exec/code_exec_test/get_exec_test.py")
print(exec_result[0])
